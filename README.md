...
This package's types live in `DekiLovyanGfx`. Scene files store the qualified
name, so a component is `DekiLovyanGfx::SomeComponent` there, and code naming one
needs the namespace:
